...
<table cellspacing='5' cellpadding='1' class='form-table'>
    ...
    <tr><td>День народження: &nbsp;</td><td><input type='text' name='birthday' style='width:250px;' value='<??>'></td></tr>
    <tr><td>День народж.дружини: &nbsp;</td><td><input type='text' name='wbirthday' style='width:250px;' value='<??>'></td></tr>
    <tr><td>Кількість дітей: &nbsp;</td><td><input type='text' name='children' style='width:250px;' value='<??>'></td></tr>
    <tr><td>Страхівка: &nbsp;</td><td><input type='text' name='insurance' style='width:250px;' value='<??>'></td></tr>
